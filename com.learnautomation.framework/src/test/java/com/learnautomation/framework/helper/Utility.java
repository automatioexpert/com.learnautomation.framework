...
public class Utility {
	/*
	 * add methods for frame alert currenturl title
	 * 
	 */

	public static void waitAndAcceptAlert(WebDriver driver, String logInfo) {
	...
	public static void waitAndType(WebDriver driver, By locator, String text, String logInfo) {
		WebElement ele=new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(locator));
